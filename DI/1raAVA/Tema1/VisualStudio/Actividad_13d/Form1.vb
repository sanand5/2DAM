...
Public Class Form1
    ...
    Private Sub btn_close_Click(sender As Object, e As EventArgs) Handles btn_close.Click, mn_exit.Click
        Close()
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn_bgcolor.Click, mn_bgcolor.Click
    ...
    Private Sub btn_fgcolor_Click(sender As Object, e As EventArgs) Handles btn_fgcolor.Click, mn_fcolor.Click
        Dim colorDialog As New ColorDialog()
        If colorDialog.ShowDialog() = DialogResult.OK Then
